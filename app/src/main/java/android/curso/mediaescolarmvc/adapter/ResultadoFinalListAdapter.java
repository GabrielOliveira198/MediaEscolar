...
public class ResultadoFinalListAdapter
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.imgLogo:
                ...
                Snackbar.make(view, "Nota 1 " + mediaEscolar.getNotaProva(),
            ...
            case R.id.imgDeletar:
                ...
                build.setMessage("Deseja apagar este registro?");
                build.setCancelable(true);
                build.setIcon(R.mipmap.ic_launcher);
    ...
    @Override
    public void registerDataSetObserver(DataSetObserver observer) { //o observador deve conhecer o observado
    ...
    public View getView(int position,
                        View dataSet,
                        @NonNull ViewGroup parent) { //o observado deve notificar o observador quando for atualizado
        ...
        if(mediaEscolar.getMediaFinal()<6)  linha.txtSituacao.setText("Reprovado");
